...
const Game = (() => {
  ...
  function _drawCombat(ctx) {
    ...
    if (_playerShip) {
      ...
      ctx.fillStyle = '#ff7c20'; ctx.font = '8px Share Tech Mono, monospace';
      ctx.textAlign = 'center';
  ...
  function _drawEvent(ctx) {
    ...
    ctx.fillStyle = '#4db8ff'; ctx.font = '11px Orbitron, monospace';
    ctx.textAlign = 'left';
    ctx.fillText(_event.title, ex+20, ey+30);

    ctx.fillStyle = '#c8d8f0'; ctx.font = '8px Share Tech Mono, monospace';
