...
class Ship {
  ...
  _updateBodies(dt) {
    ...
    this.crew.forEach(c => {
      ...
      if (!(c._bleedT > 0)) {
        c._bleedMax = Ship.BLEEDOUT_SECONDS
          + ((this.isPlayer && typeof Captain !== 'undefined')
             ? Captain.shipBonus('bleedout') : 0);
      }
    ...
    this.crew.forEach(body => {
      ...
      const aid = 1 + (typeof Captain !== 'undefined'
        ? (this.isPlayer ? Captain.shipBonus('fieldAid') : 0) : 0);
  ...
  update(dt) {
    ...
    this.weapons.forEach((w, i) => {
      ...
      const chipFire = (this.isPlayer && typeof Captain !== 'undefined')
        ? Captain.shipBonus('weaponCharge') : 0;
