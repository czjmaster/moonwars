...
class ElevatorShaft {
  ...
  draw(ctx) {
    ...
    ctx.fillRect(x - tw/2, this.topY - 20, tw, this.height + 40);
    ctx.strokeStyle = '#1e2d4a';
    ctx.lineWidth = 1.5;
    ctx.strokeRect(x - tw/2, this.topY - 20, tw, this.height + 40);

    // Rails
    ctx.fillStyle = '#1a2a3a';
    ctx.fillRect(x - tw/2 + 4, this.topY - 16, 3, this.height + 32);
    ctx.fillRect(x + tw/2 - 7, this.topY - 16, 3, this.height + 32);
