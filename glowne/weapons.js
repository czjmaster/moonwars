...
const WEAPON_DEFS = {
  laser_basic: {
    ...
    projectileSpeed: 400, missileUse: 0,
  ...
  missile_basic: {
    ...
    projectileSpeed: 250, missileUse: 1,
  ...
  ion_basic: {
    ...
    projectileSpeed: 350, missileUse: 0,
    ionHits: 1,
  ...
  cannon_basic: {
    ...
    projectileSpeed: 300, missileUse: 1,
  ...
  laser_heavy: {
    ...
    projectileSpeed: 380, missileUse: 0,
  ...
  flak_basic: {
    ...
    projectileSpeed: 320, missileUse: 0,
